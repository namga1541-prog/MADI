...
function printParentEdu(childName) {
  ...
  win.document.write('<!DOCTYPE html><html><head><meta charset="UTF-8">'
    ...
    + 'body{font-family:"Pretendard",sans-serif;padding:40px;color:#1e293b;line-height:1.9;max-width:700px;margin:0 auto;}'
    + 'h1{color:#0E6B5C;font-size:20px;border-bottom:3px solid #0E6B5C;padding-bottom:8px;margin-bottom:20px;}'
    + '.meta{font-size:13px;color:#64748b;margin-bottom:24px;}'
    + 'pre{white-space:pre-wrap;font-family:"Pretendard",sans-serif;font-size:14px;}'
