...
function renderDashboardTeacher() {
  ...
  if (recentChildren.length === 0) {
    ...
    html += '<div class="dp-children">' + recentChildren.map(function(c){
      ...
      return ''
        + '<div class="dp-child" onclick="openChildDetail(\'' + jsArg(String(c.id)) + '\')">'
  ...
  html += ''
    ...
    +     '</div>'
    +     '<div class="dp-tl-row" style="grid-template-columns:auto 1fr auto;padding:11px 0;border-top:1px solid var(--border);cursor:pointer;" onclick="switchTab(0)">'
    ...
    +       '<div style="color:var(--text2);">→</div>'
    +     '</div>'
    +     '<div class="dp-tl-row" style="grid-template-columns:auto 1fr auto;padding:11px 0;border-top:1px solid var(--border);cursor:pointer;" onclick="switchTab(7)">'
...
function renderDashboardAdmin() {
  ...
  if (sortedChanges.length === 0) {
    ...
    sortedChanges.slice(0, 5).forEach(function(c){
      ...
      html += ''
        + '<div class="dp-change-row" onclick="openChildDetail(\'' + jsArg(String(c.id)) + '\')" style="cursor:pointer;">'
  ...
  html += ''
    ...
    +       '<div style="color:var(--text2);">→</div>'
    +     '</div>'
    +     '<div class="dp-tl-row" style="grid-template-columns:auto 1fr auto;padding:11px 0;border-top:1px solid var(--border);cursor:pointer;" onclick="goToAdmin(\'service\')">'
    ...
    +       '<div style="color:var(--text2);">→</div>'
    +     '</div>'
    +     '<div class="dp-tl-row" style="grid-template-columns:auto 1fr auto;padding:11px 0;border-top:1px solid var(--border);cursor:pointer;" onclick="switchTab(2)">'
