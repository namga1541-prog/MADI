...
function _renderParentChartByScore(assessments) {
  ...
  var html = ''
    ...
    +   '<svg class="dp-p-chart-svg" role="img" aria-label="최근 ' + months.length + '개월 평가 점수 평균 추이 그래프' + (months.length ? ', 최근 ' + Math.round(months[months.length-1].avg) + '점' : '') + '" viewBox="0 0 ' + W + ' ' + H + '" preserveAspectRatio="none">'
...
function _renderParentChart(sessions) {
  ...
  var html = ''
    + '<div class="dp-p-chart-area">'
    +   '<div class="dp-p-chart-grid"><div class="dp-p-chart-grid-line"></div><div class="dp-p-chart-grid-line"></div><div class="dp-p-chart-grid-line"></div><div class="dp-p-chart-grid-line"></div><div class="dp-p-chart-grid-line"></div></div>'
    +   '<svg class="dp-p-chart-svg" role="img" aria-label="최근 ' + months.length + '개월 진행 세션 수 추이 그래프' + (months.length ? ', 최근 ' + months[months.length-1].count + '회' : '') + '" viewBox="0 0 ' + W + ' ' + H + '" preserveAspectRatio="none">'
